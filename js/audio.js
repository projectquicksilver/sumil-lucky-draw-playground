...
window.LuckyAudio = (function () {
  ...
  css.textContent =
    '#ld-audio-ctl{position:fixed;right:14px;bottom:14px;z-index:900;display:flex;flex-direction:column;align-items:center;gap:8px;' +
      'padding:10px 8px 14px 8px;border-radius:40px;' +
    ...
    '#ld-vol{-webkit-appearance:slider-vertical;appearance:slider-vertical;width:4px;height:80px;border-radius:4px;outline:none;cursor:pointer;' +
      'background:linear-gradient(0deg,#FFD700 var(--p,60%),rgba(255,215,0,.18) var(--p,60%));}' +
    ...
    '#ld-audio-ctl .ld-ico{font-size:13px;line-height:1;filter:drop-shadow(0 0 6px rgba(255,215,0,.6));}' +
    '@media (max-width:560px){#ld-audio-ctl{right:8px;bottom:8px;padding:8px 6px 10px 6px;}#ld-vol{height:60px;}}';
  ...
  wrap.innerHTML =
    ...
    '<span class="ld-ico" style="margin-bottom:-4px;">🔊</span>' +
    '<input id="ld-vol" type="range" min="0" max="100" step="1" title="Volume">' +
    '<span class="ld-ico" style="margin-top:-4px;">🔉</span>';
